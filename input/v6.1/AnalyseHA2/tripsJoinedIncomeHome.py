...
trips_file_path = os.path.join(script_dir, 'C:/Users/jamps/MatSim/BerlinHA2/output/outputsFuerAnalyse/berlin-v6.1-bike-cluster-base-fixing-too-much-bike-400.output_trips.csv.gz')
