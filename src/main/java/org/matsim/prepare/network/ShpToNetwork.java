...
public class ShpToNetwork {
    ...
    public static void main (String[] args) {
    	...
    	*//*String rootDirectory = null;
	    ...
	    final String inputShapeNetwork = "./src/main/java/org/matsim/prepare/network/Links2Shp.shp";
		Network network = new ShpToNetwork().run(Paths.get(inputShapeNetwork));

		NetworkWriter writer = new NetworkWriter(network);

	    final String matSimOutputNetwork ="./src/main/java/org/matsim/prepare/network/Shp2Net.xml.gz";
