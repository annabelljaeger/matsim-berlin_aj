...
import static tech.tablesaw.aggregate.AggregateFunctions.*;
	...
	public class RoadPricingAnalyse_Mexico implements MATSimAppCommand{

		Logger log = LogManager.getLogger(RoadPricingAnalyse_Mexico.class);

		@CommandLine.Mixin
		private InputOptions input = InputOptions.ofCommand(RoadPricingAnalyse_Mexico.class);
		@CommandLine.Mixin
		private OutputOptions output = OutputOptions.ofCommand(RoadPricingAnalyse_Mexico.class);
		...
		public static void main(String[] args) {
			new RoadPricingAnalyse_Mexico().execute(args);
		}
...
//		how to sort rows here? agg.sortOn does not work! Using workaround instead. -sme0324
			...
			incomeDistr.sort(Comparator.comparingInt(RoadPricingAnalyse_Mexico::getLowerBound));
			avgTolls.sort(Comparator.comparingInt(RoadPricingAnalyse_Mexico::getLowerBound));
